    ...
    <section className="flex flex-col md:flex-row gap-5 sm:mx-auto">
      ...
      <div className="md:w-8/12">
        ...
        <div className="row">
          ...
          <button type="button" className="key w-3/12" onClick={() => handleButtonClick('%')}>%</button>
          <button type="button" className="key !bg-orange-400 w-3/12" onClick={() => handleButtonClick('÷')}>÷</button>
        </div>
        <div className="row">
          ...
          <button type="button" className="!bg-orange-400 key w-3/12" onClick={() => handleButtonClick('x')}>x</button>
        </div>
        <div className="row">
        ...
        <div className="flex">
          ...
          <button type="button" className="key w-3/12" onClick={() => handleButtonClick('.')}>.</button>
          <button type="button" className="!bg-orange-400 w-3/12" onClick={() => handleButtonClick('=')}>=</button>
        </div>
      </div>
    </section>
  );
